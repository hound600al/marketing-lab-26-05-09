...
NEW_ORDER = [
    ...
    ("p990",     8),   # 990원 진입 이벤트 LP   (growth 01/01) ← 구 11
    ("p9",       9),   # 페이백 RCT (LP + 인플 영상) (CRM 01/01) ← 구 12
    ("p11",     10),   # T-ROAS                (perf 02/02) ← 구 8
    ("p6",      11),   # D45 CVR (알림톡 콘텐츠) (growth·CRM 01/02) ← 구 9
    ("p4",      12),   # M1 등급제 (모바일 직접 제작) (growth·CRM 02/02) ← 구 10
